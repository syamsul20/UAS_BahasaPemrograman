	...
	<body>
	    ...
	    <table border="0" width="1300" style="text-align:center">
	      ...
	      <div class="panel-body">
				<form method="POST" action="ProsesKehadiran.php" class="form-horizontal">
					<div class="input-group">
						<span class="input-group-addon">
							...
							<input type="text" name="NIS" placeholder="Masukan Nomor Induk Siswa" class="form-control input-lg text-center" required>
					</div>
					</div>
					<center>
        		...
        		<button type="Submit" name="Hadir" value="Masuk" class="btn btn-info btn-lg">
